                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <h1 class="breadcrumbs-title">Services3</h1>
                                    <div class="back-nav">
                                        <ul>
                        ...
                        <div class="row pb-120">
                                ...
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/grc.png')}}" alt="This the first card image">
                                        </a>
                                    ...
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            ...
                                            <h3 class="blog__card--title"><a href="#">Governance Risk and Compliance <br />(GRC) Management</a></h3>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/data-science.png')}}">
                                        </a>
                                    ...
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            ...
                                            <h3 class="blog__card--title"><a href="#">Data Science and Business Intelligence</a>
                                                <br /> <br />
                                            </h3>
                                            <!-- <a class="blog__card--link" href="blog-details.html">Read more<i class="arrow_right blog__card--link-icon"></i></a> -->
                                        </div>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/digital.png')}}">
                                        </a>
                                    ...
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            ...
                                            <h3 class="blog__card--title"><a href="#">Digital Transformation and Innovation</a>
                                                <br /> <br />
                                            </h3>
                                            <!-- <a class="blog__card--link" href="blog-details.html">Read more<i class="arrow_right blog__card--link-icon"></i></a> -->
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/it.png')}}">
                                        </a>
                                        <!-- <a class="blog__thumb--pre-title" href="blog.html">Podcast</a> -->
                                    </div>
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            <!-- <span class="blog__card--date">April 10, 2022</span> -->
                                            <h3 class="blog__card--title"><a href="#">Information Technology</a>
                                                <br /><br />
                                            </h3>
                                            <!-- <a class="blog__card--link" href="blog-details.html"> Read more <i class="arrow_right blog__card--link-icon"></i></a> -->
                                        </div>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/telecommunication.png')}}">
                                        </a>
                                        <!-- <a class="blog__thumb--pre-title" href="blog.html">Video</a> -->
                                    </div>
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            <!-- <span class="blog__card--date">July 18, 2022</span> -->
                                            <h3 class="blog__card--title"><a href="#">Telecommunication</a>
                                                <br /><br />
                                            </h3>
                                            <!-- <a class="blog__card--link" href="blog-details.html">Read more<i class="arrow_right blog__card--link-icon"></i></a> -->
                                        </div>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="blog__card mb-50">
                                    <div class="blog__thumb w-img p-relative">
                                        <a class="blog__thumb--image" href="blog-details.html">
                                            <img src="{{asset('assets/images/our-services/logistics.png')}}">
                                        </a>
                                        <!-- <a class="blog__thumb--pre-title" href="blog.html">Article</a> -->
                                    </div>
                                    <div class="blog__card--content">
                                        <div class="blog__card--content-area mb-25">
                                            <!-- <span class="blog__card--date">October 10, 2021</span> -->
                                            <h3 class="blog__card--title"><a href="#">Logistics & Transportation Management</a></h3>
                                            <!-- <a class="blog__card--link" href="blog-details.html">Read more<i class="arrow_right blog__card--link-icon"></i></a> -->
                                        </div>
                                    </div>
                                </div>
